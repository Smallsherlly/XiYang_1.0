...
import com.example.silence.xiyang_10.models.Tag;
...
public class TagsHelper {
	...
	public static HashMap<String, Integer> retrieveTags(HandEdit note) {
    ...
    public static Pair<String, List<Tag>> addTagToNote(List<Tag> tags, Integer[] selectedTags, HandEdit note) {
    ...
    public static Integer[] getPreselectedTagsArray(HandEdit note, List<Tag> tags) {
        List<HandEdit> notes = new ArrayList<>();
        notes.add(note);
        return getPreselectedTagsArray(notes, tags);
    }


    public static Integer[] getPreselectedTagsArray(List<HandEdit> notes, List<Tag> tags) {
